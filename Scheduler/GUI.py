...
class GUI:
	def __init__(self, scheduler: Scheduler):
		...
		"""
		self.list = Frame(master=self.window, bg=GREY2, highlightthickness=.5, highlightbackground=GREY1, highlightcolor=GREY1, border=0, width=0)
	...
	def update_list(self, jobs: list[Job]):
		for j, header in enumerate(["Process:", "Arrival ms:", "Burst ms:", "Priority:"]):
			label = Label(master=self.list, text=header, bg=GREY2, fg=WHITE1, font=("Arial", 10, "bold"), border=0, justify=LEFT)
