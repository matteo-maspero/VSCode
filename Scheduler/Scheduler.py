...
scheduler.add_process(Job("a", 10, 5, 0))
scheduler.add_process(Job("b", 23, 23, 0))
scheduler.add_process(Job("c", 43, 4, 0))
scheduler.add_process(Job("d", 5, 3, 0))
scheduler.add_process(Job("e", 43, 12, 0))
